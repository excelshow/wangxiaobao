...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_yinliu_share_share__ = __webpack_require__(441);
/**
 * Created by Administrator on 2017/3/10.
 */
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__lib_common_navBar__["a" /* NavBar */], { selectedChanelKey: 7, selectedItemKey: 1, hasBrand: true }), document.getElementById('nav'));
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__lib_yinliu_share_share__["a" /* Share */], null), document.getElementById('app'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_qnui_lib_field__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_qnui_lib_field___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_qnui_lib_field__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_qnui_lib_input__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_qnui_lib_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_qnui_lib_input__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__store_yinliu_shareStore__ = __webpack_require__(453);
...
var Share = function (_Reflux$Component) {
    _inherits(Share, _Reflux$Component);
    ...
    function Share(props) {
        ...
        _this.stores = [__WEBPACK_IMPORTED_MODULE_15__store_yinliu_shareStore__["a" /* ProductStore */]];
        _this.field = new __WEBPACK_IMPORTED_MODULE_10_qnui_lib_field___default.a(_this, {
            onChange: function onChange(name, value) {
                switch (name) {
                    case 'item_id':
                        _this.input(name, value);break;
                }
            }
        });
        return _this;
    ...
    _createClass(Share, [{
        ...
        value: function getSites() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].getSites();
        }
        //下载商品
        ...
        value: function download() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].download();
        }
    }, {
        key: 'closeDownloader',
        value: function closeDownloader() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].closeDownloader();
        }
    }, {
        key: 'input',
        value: function input(field, value) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].input(field, value);
        }
        ...
        value: function getProducts() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].getProducts();
        }
        //选择记录
        ...
        value: function selectRows(selectedRowKeys, records) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].selectRows(selectedRowKeys, records);
        }
        //翻页
        ...
        value: function changePage(page) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].changePage(page);
        }
        //设置页面大小
        ...
        value: function setPageSize(size) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].setPageSize(size);
        }
        //查询
        ...
        value: function search() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].search();
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].getProducts();
        }
        ...
        key: 'share',
        value: function share(site) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].share(site);
        }
    }, {
        key: 'openSharer',
        value: function openSharer(record) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].openSharer(record);
        }
    }, {
        key: 'closeSharer',
        value: function closeSharer() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["a" /* ShareActions */].closeSharer();
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_qnui_lib_input___default.a, _extends({ hasLimitHint: true, style: { width: 200 }, placeholder: '\u5546\u54C1ID'
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u4E0B\u8F7D\u65F6\u95F4', dataIndex: 'created_at' }),
                            ...
                            cell: function cell(value, index, record) {
                                var tpl = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            'a',
                                            { href: 'javascript:void(0)', onClick: _this2.openSharer.bind(_this2, record) },
                                            '\u5206\u4EAB'
                                        )
                                    )
                                );
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        __WEBPACK_IMPORTED_MODULE_5_qnui_lib_grid__["Row"],
                        { type: 'wrap', className: 'jiathis_style_32x32', justify: 'start' },
                        sites.map(function (data) {
                            var web_id = data.web_id;

                            var icon = 'jtico jtico_' + web_id;
                            var col = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                __WEBPACK_IMPORTED_MODULE_5_qnui_lib_grid__["Col"],
                                { span: '4', key: data.id, className: 'margin-b-15' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    { onClick: _this2.share.bind(_this2, data) },
...
var ProductStore = function (_Reflux$Store) {
    ...
    function ProductStore() {
        ...
        _this.listenables = [__WEBPACK_IMPORTED_MODULE_2__action_yinliu_yinliuActions__["a" /* ShareActions */]];
        _this.state = {
            query: {
                field: 'item_id',
                data: ''
    ...
    _createClass(ProductStore, [{
        key: 'onShare',
        value: function onShare(site) {
            //console.log(site);
            var sharer = this.state.sharer;
            var product = sharer.product;
            var web_id = site.web_id;
            var item_id = product.item_id,
                title = product.title,
                imgUrl = product.img_url;

            var url = 'https://detail.1688.com/offer/' + item_id + '.html';
            var shareUrl = 'http://www.jiathis.com/send/?webid=' + web_id + '&url=' + url + '&title=' + title + '&summary=' + '&pic=' + imgUrl + '&uid=';
            window.open(shareUrl, '_blank');
        }
    }, {
        key: 'onOpenSharer',
        value: function onOpenSharer(product) {
            var sharer = this.state.sharer;
        ...
        value: function onChangePage(pageNum) {
            ...
            page.page = pageNum;
            this.setState({ page: page });
            __WEBPACK_IMPORTED_MODULE_2__action_yinliu_yinliuActions__["a" /* ShareActions */].getProducts();
        }
        ...
        value: function onGetSites() {
            ...
            $.ajax({
                ...
                _this4.setState({ sites: response });
            }).fail(function (response) {
                __WEBPACK_IMPORTED_MODULE_1_qnui_lib_dialog___default.a.alert({
                    content: '请求失败',
                    closable: true,
