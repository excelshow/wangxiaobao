...
var _progressLine = __webpack_require__(250);

var _progressLine2 = _interopRequireDefault(_progressLine);

var _progressCircle = __webpack_require__(249);
...
var Progress = (_temp = _class = function (_Component) {
  ...
  Progress.prototype.render = function render() {
    ...
    var props = _extends({}, this.props, { suffix: newSuffix, prefix: newPrefix });
...
var Circle = (_temp = _class = function (_Component) {
    ...
    Circle.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
        if (prevProps.percent !== this.props.percent && this.overlay) {
    ...
    Circle.prototype.render = function render() {
        ...
        var overlayPathStyle = {
            ...
            strokeDashoffset: overlayLen + 'px' };
...
var Line = (_temp = _class = function (_Component) {
    ...
    Line.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            percent = _props.percent,
            className = _props.className,
            others = _objectWithoutProperties(_props, ['prefix', 'size', 'showInfo', 'type', 'suffix', 'state', 'percent', 'className']);
        ...
        return _react2['default'].createElement(
            ...
            _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement('div', { className: lineCls, style: { width: '0%' }, ref: this._lineRefHandler.bind(this) })
                )
            ),
            showInfo ? _react2['default'].createElement(
                'div',
...
var _columnGroup = __webpack_require__(255);

var _columnGroup2 = _interopRequireDefault(_columnGroup);

var _groupHeader = __webpack_require__(258);
...
var _classnames6 = __webpack_require__(1);
...
var Table = (_temp = _class = function (_React$Component) {
    ...
    */
    ...
    /**
    * 是否启用选择模式
     * @param getProps `Function(record)=>Object` 获取selection的默认属性
     * @param onChange `Function(selectedRowKeys:Array, records:Array)` 选择改变的时候触发的事件，**注意:** 其中records只会包含当前dataSource的数据，很可能会小于selectedRowKeys的长度。
     * @param onSelect `Function(selected:Boolean, record:Object, records:Array)` 用户手动选择/取消选择某行的回调
     * @param onSelectAll `Function(selected:Boolean, records:Array)` 用户手动选择/取消选择所有行的回调
     * @param {Array} selectedRowKeys 设置了此属性,将rowSelection变为受控状态,接收值为该行数据的primaryKey的值
     * @param {String} mode 选择selection的模式, 可选值为`single`, `multiple`，默认为`multiple`
    */
...
var _nextSelect = __webpack_require__(162);

var _nextSelect2 = _interopRequireDefault(_nextSelect);

var _nextMixinKeyBinder = __webpack_require__(265);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_yinliu_product_product__ = __webpack_require__(440);
/**
 * Created by Administrator on 2017/3/10.
 */
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__lib_common_navBar__["a" /* NavBar */], { selectedChanelKey: 6, selectedItemKey: 1, hasBrand: true }), document.getElementById('nav'));
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__lib_yinliu_product_product__["a" /* Product */], null), document.getElementById('app'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_qnui_lib_table__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_qnui_lib_pagination__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_qnui_lib_pagination___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_qnui_lib_pagination__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_qnui_lib_dialog__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_qnui_lib_dialog___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_qnui_lib_dialog__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_qnui_lib_form__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_qnui_lib_form___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_qnui_lib_form__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_qnui_lib_input__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_qnui_lib_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_qnui_lib_input__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_qnui_lib_field__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_qnui_lib_field___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_qnui_lib_field__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_qnui_lib_select__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_qnui_lib_select___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_qnui_lib_select__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_qnui_lib_progress__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_qnui_lib_progress___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_qnui_lib_progress__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__store_yinliu_productStore__ = __webpack_require__(452);
...
var Product = function (_Reflux$Component) {
    _inherits(Product, _Reflux$Component);
    ...
    function Product(props) {
        ...
        _this.stores = [__WEBPACK_IMPORTED_MODULE_15__store_yinliu_productStore__["a" /* ProductStore */]];
        _this.field = new __WEBPACK_IMPORTED_MODULE_11_qnui_lib_field___default.a(_this, {
    ...
    _createClass(Product, [{
        ...
        value: function download() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].download();
        }
    }, {
        key: 'closeDownloader',
        value: function closeDownloader() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].closeDownloader();
        }
        ...
        value: function deleteAll() {
            ...
            if (selectedKeys.length == '0') {
                __WEBPACK_IMPORTED_MODULE_8_qnui_lib_dialog___default.a.alert({
                    content: '请选择要删除的记录',
                    closable: true,
                    title: '提示',
                    onOk: function onOk() {}
            ...
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].deleteAll();
        }
        ...
        value: function cancel() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].cancel();
        }
        //添加
        ...
        key: 'add',
        value: function add() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].add();
        }
        ...
        value: function _delete(record) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].delete(record);
        }
        //获取
        ...
        key: 'get',
        value: function get() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].get();
        }
        //选择记录

    }, {
        key: 'selectRows',
        value: function selectRows(selectedRowKeys, records) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].selectRows(selectedRowKeys, records);
        }
        //翻页
        ...
        value: function changePage(page) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].changePage(page);
        }
        //设置页面大小
        ...
        value: function setPageSize(size) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].setPageSize(size);
        }
        //查询
        ...
        value: function search() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].search();
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].get();
        }
        ...
        key: 'getBusinesses',
        value: function getBusinesses() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].getBusinesses();
        }
    }, {
        key: 'selectBusiness',
        value: function selectBusiness(business) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["b" /* ProductActions */].selectBusiness(business);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var _state = this.state,
                ...
                downloader = _state.downloader,
                products = _state.products,
                page = _state.page,
                businesses = _state.businesses;
            var process = downloader.process;
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            __WEBPACK_IMPORTED_MODULE_5_qnui_lib_grid__["Row"],
                            { type: 'no-padding', className: '' },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                __WEBPACK_IMPORTED_MODULE_5_qnui_lib_grid__["Col"],
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        __WEBPACK_IMPORTED_MODULE_9_qnui_lib_form___default.a,
                                        { field: this.field, direction: 'hoz' },
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            __WEBPACK_IMPORTED_MODULE_9_qnui_lib_form__["Item"],
                                            { className: 'margin-b-0',
                                                label: '\u9009\u62E9\u4E1A\u52A1\uFF1A'
                                            },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                __WEBPACK_IMPORTED_MODULE_12_qnui_lib_select___default.a,
                                                _extends({
                                                    placeholder: '\u8BF7\u9009\u62E9\u6240\u5C5E\u4E1A\u52A1',
                                                    style: { width: 150 }
                                                }, init('business', {
                                                    rules: [{ required: false, message: '请选择所属业务' }]
                                                    // props: {onChange: this.selectProductPrinter.bind(this)},
                                                })),
                                                businesses.map(function (data) {
                                                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                        __WEBPACK_IMPORTED_MODULE_12_qnui_lib_select__["Option"],
                                                        { key: data.id, value: data.id, onClick: _this2.selectBusiness.bind(_this2, data) },
                                                        data.business
                                                    );
                                                })
                                            )
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                __WEBPACK_IMPORTED_MODULE_3_qnui_lib_button___default.a,
                                                { type: 'primary', onClick: this.add.bind(this) },
                                                '\u63A8\u5E7F'
                                            ),
                                            '\xA0\xA0',
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                __WEBPACK_IMPORTED_MODULE_3_qnui_lib_button___default.a,
                                                { type: 'primary', onClick: this.deleteAll.bind(this) },
                                                '\u5220\u9664'
                                            ),
                                            '\xA0\xA0',
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                __WEBPACK_IMPORTED_MODULE_3_qnui_lib_button___default.a,
                                                { type: 'primary', onClick: this.download.bind(this) },
                                                '\u4E0B\u8F7D\u5546\u54C1'
                                            ),
                                            '\xA0\xA0'
                                        )
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_qnui_lib_pagination___default.a, {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        __WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a,
                        { dataSource: products.rows,
                            rowSelection: rowSelection,
                            primaryKey: 'id'
                        },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u5546\u54C1\u7F16\u53F7', dataIndex: 'item_id' }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u4E3B\u56FE', dataIndex: 'img_url',
                            cell: function cell(value, index, record) {
                                var tpl = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: record.img_url, className: 'img-product' });
                                return tpl;
                            }
                        }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u6807\u9898', dataIndex: 'title' }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u6240\u5C5E\u4E1A\u52A1', dataIndex: 'business',
                            cell: function cell(value, index, record) {
                                var tpl = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    null,
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u63A8\u5E7F\u65F6\u95F4', dataIndex: 'created_at' }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u64CD\u4F5C', width: 200,
                            cell: function cell(value, index, record) {
                                var tpl = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'ul',
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            'a',
                                            { href: 'javascript:void(0)', onClick: _this2.delete.bind(_this2, record) },
                                            '\u5220\u9664'
                                        )
                                    )
                                );
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    __WEBPACK_IMPORTED_MODULE_8_qnui_lib_dialog___default.a,
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Editor, { ref: 'editor' })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    __WEBPACK_IMPORTED_MODULE_8_qnui_lib_dialog___default.a,
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_qnui_lib_progress___default.a, { percent: process.percent, suffix: process.percent + '%' }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'ul',
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
var Editor = function (_Reflux$Component2) {
    _inherits(Editor, _Reflux$Component2);
    ...
    function Editor(props) {
        ...
        _this3.stores = [__WEBPACK_IMPORTED_MODULE_15__store_yinliu_productStore__["b" /* EditorStore */]];
        _this3.field = new __WEBPACK_IMPORTED_MODULE_11_qnui_lib_field___default.a(_this3, {
            onChange: function onChange(name, value) {
                switch (name) {
                    case 'item_id':
                        _this3.input(name, value);break;
                    case 'business':
                        break;
                }
            }
    ...
    _createClass(Editor, [{
        ...
        key: 'selectRows',
        value: function selectRows(selectedRowKeys, records) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].selectRows(selectedRowKeys, records);
        }
        //输入

    }, {
        key: 'input',
        value: function input(field, value) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].input(field, value);
        }
        //保存
        ...
        key: 'save',
        value: function save() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].save();
        }
        ...
        key: 'search',
        value: function search() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].search();
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].get();
        }
        //获取全部商品
        ...
        key: 'getBusinesses',
        value: function getBusinesses() {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].getBusinesses();
        }
        //翻页
        ...
        key: 'changePage',
        value: function changePage(page) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].changePage(page);
        }
        ...
        key: 'setPageSize',
        value: function setPageSize(size) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].setPageSize(size);
        }
        ...
        key: 'selectBusiness',
        value: function selectBusiness(business) {
            __WEBPACK_IMPORTED_MODULE_14__action_yinliu_yinliuActions__["c" /* BaseProductActions */].selectBusiness(business);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var _state2 = this.state,
                ...
                page = _state2.page,
                businesses = _state2.businesses,
                business = _state2.business;
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                businesses.map(function (data) {
                                                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                        __WEBPACK_IMPORTED_MODULE_12_qnui_lib_select__["Option"],
                                                        { key: data.id, value: data.id, onClick: _this4.selectBusiness.bind(_this4, data) },
                                                        data.business
                                                    );
                                                })
                                            )
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            __WEBPACK_IMPORTED_MODULE_9_qnui_lib_form__["Item"],
                                            { className: 'margin-b-0' },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_qnui_lib_input___default.a, _extends({ hasLimitHint: true, style: { width: 150 }, placeholder: '\u5546\u54C1ID'
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u6807\u9898', dataIndex: 'title' }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_qnui_lib_table___default.a.Column, { title: '\u662F\u5426\u63A8\u5E7F', dataIndex: 'has_promoted',
                            cell: function cell(value, index, record) {
                                var text = value ? '已推广' : '未推广';
                                return text;
                            }
                        })
                    ),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return EditorStore; });
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var ProductStore = function (_Reflux$Store) {
    _inherits(ProductStore, _Reflux$Store);
    ...
    function ProductStore() {
        ...
        _this.listenables = [__WEBPACK_IMPORTED_MODULE_2__action_yinliu_yinliuActions__["b" /* ProductActions */]];
        _this.state = {
            businesses: [{ id: '', business: '全部' }],
            business: { id: '' },
    ...
    _createClass(ProductStore, [{
        ...
        value: function onDownload() {
            ...
            var downloader = this.state.downloader;
            var process = downloader.process,
            ...
            var pid = setInterval(function () {
                $.ajax({
                    ...
                    if (response) {
                        ...
                        _this2.setState({ downloader: downloader });
        ...
        key: 'onCloseDownloader',
        value: function onCloseDownloader() {
            var downloader = this.state.downloader;
            ;
            downloader.visible = false;
            this.setState({ downloader: downloader });
        ...
        value: function onChangePage(pageNum) {
            ...
            page.page = pageNum;
            this.setState({ page: page });
            __WEBPACK_IMPORTED_MODULE_2__action_yinliu_yinliuActions__["b" /* ProductActions */].get();
        }
        ...
        key: 'onSetPageSize',
        value: function onSetPageSize(size) {
            var page = this.state.page;
        ...
        value: function onGet() {
            ...
            $.ajax({
                ...
                _this3.setState({ products: response });
            }).fail(function (response) {
                __WEBPACK_IMPORTED_MODULE_1_qnui_lib_dialog___default.a.alert({
                    content: '请求失败',
                    closable: true,
        ...
        key: 'onDelete',
        value: function onDelete(record) {
            var id = record.id;
        ...
        key: 'onSelectRows',
        value: function onSelectRows(selectedRowKeys, records) {
        ...
        key: 'onSelectBusiness',
        value: function onSelectBusiness(business) {
        ...
        key: 'onGetBusinesses',
        value: function onGetBusinesses() {
            var _this4 = this;
            ...
            $.ajax({
                ...
                _this4.setState({ businesses: businesses });
            }).fail(function (response) {
                __WEBPACK_IMPORTED_MODULE_1_qnui_lib_dialog___default.a.alert({
                    content: '获取业务失败',
                    closable: true,
...
var EditorStore = function (_Reflux$Store2) {
    _inherits(EditorStore, _Reflux$Store2);

    function EditorStore() {
        _classCallCheck(this, EditorStore);

        var _this5 = _possibleConstructorReturn(this, (EditorStore.__proto__ || Object.getPrototypeOf(EditorStore)).call(this));

        _this5.listenables = [__WEBPACK_IMPORTED_MODULE_2__action_yinliu_yinliuActions__["c" /* BaseProductActions */]];
        _this5.state = {
            query: {
                field: 'item_id',
                data: ''
    ...
    _createClass(EditorStore, [{
        ...
        value: function onChangePage(pageNum) {
            ...
            page.page = pageNum;
            this.setState({ page: page });
            __WEBPACK_IMPORTED_MODULE_2__action_yinliu_yinliuActions__["c" /* BaseProductActions */].get();
        }
        ...
        key: 'onInput',
        value: function onInput(filed, value) {
        ...
        value: function onSave() {
            var _state2 = this.state,
                business = _state2.business,
                selectedRecords = _state2.selectedRecords;
            ...
            var url = '/app/yinliu/product/add';
        ...
        value: function onGetBusinesses() {
            ...
            $.ajax({
                ...
                _this6.setState({ businesses: response });
            }).fail(function (response) {
                __WEBPACK_IMPORTED_MODULE_1_qnui_lib_dialog___default.a.alert({
                    content: '获取业务失败',
                    closable: true,
        ...
        value: function onGet() {
            ...
            $.ajax({
                ...
                _this7.setState({ products: response });
            }).fail(function (response) {
                __WEBPACK_IMPORTED_MODULE_1_qnui_lib_dialog___default.a.alert({
                    content: '请求失败',
                    closable: true,
